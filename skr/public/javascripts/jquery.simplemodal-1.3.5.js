...
;(function ($) {
	...
	$.modal.defaults = {
		...
		zIndex: 1000,
		close: true,
		closeHTML: '<a class="modalCloseImg" title="Close"><img class="btn-close" src="/images/design/close/btn_close_x.png"/></a>',
	...
	$.modal.impl = {
		...
		create: function (data) {
			...
			s.d.data = data
				...
				.appendTo('body');
                        jQuery('<div class="knack-header"></div>').prependTo('.simplemodal-data');
			data = null;
