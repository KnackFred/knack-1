...
jQuery(function(){
   ...
   var size = param.split(',');
    ...
    jQuery('#form_upload').ajaxForm(function(param){
        if(param == 1)
        ...
        else
            {
                ...
                jQuery('#big_image').attr('src','/images/upload/'+ $.trim(id) +'.jpg?t='+ new Date());
                var size = param.split(',');
                rate_w = const_rate_w;
                rate_h = const_rate_h;
    ...
    jQuery('#crop-image').click(function(){
        var id = jQuery('#guid').val();
        var add_id = jQuery('#add_guid').val();
        ...
        $.ajax({
            ...
            complete: function(param){
                ...
                if(result == "200")
                {
                    jQuery('#small_image').attr('src','/images/upload/'+ $.trim(add_id) +'.jpg?t='+ new Date());
