    ...
    var icon = jQuery('#add-color');
      ...
      var dataid  = option.attr('dataid')
        ...
        var color = jQuery(this);
				var hex = color.attr('rel');
        var dataid = color.attr('dataid');
        var text = color.text();

				add_line(dataid, text, 'delete-color', 'tr-add-color');
                $('#product_color_ids').val([dataid].concat($('#product_color_ids').val()));
